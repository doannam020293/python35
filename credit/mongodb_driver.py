...
def clean_the_tin_dung_part2():
    ...
    batch_number = 1000
    query = coll_the.find({'1_1_thong_tin_nhan_dang.time_query':{"$exists":1}},{'1_1_thong_tin_nhan_dang':1})
    counter = 0
    for doc in query:
        # a = list(query)
        # doc  = a[-3]
        ...
        mobi_phone =None
        fixed_phone =None
        time_query = doc['1_1_thong_tin_nhan_dang'].get('time_query')
        try:
            if time_query is not None:
                ...
                # bulk.find({'_id':doc['_id']}).update_one({"$set":{'1_1_thong_tin_nhan_dang.time_query':new_time}})
            phone_raw = doc['1_1_thong_tin_nhan_dang'].get('phone_number')
            ...
            #     '1_1_thong_tin_nhan_dang.time_query_correct':new_time,
            #     '1_1_thong_tin_nhan_dang.phone.mobi_phone':mobi_phone,
            #     '1_1_thong_tin_nhan_dang.phone.fixed_phone':fixed_phone}})
...
def create_coll_customer():
    ...
    coll_the = db['the_tin_dung']
    pipeline = [
        { "$unwind": { "path": "$1_1_thong_tin_nhan_dang.phone.mobi_phone", 'preserveNullAndEmptyArrays': True } },
        { "$unwind": { "path": "$1_1_thong_tin_nhan_dang.phone.fixed_phone", 'preserveNullAndEmptyArrays': True } },
        {"$group": {
                "_id": "$1_1_thong_tin_nhan_dang.cic_id",
                "CMND": {"$addToSet":"$1_1_thong_tin_nhan_dang.CMND"},
                "name": {"$addToSet":"$1_1_thong_tin_nhan_dang.name"},
                "address": {"$addToSet":"$1_1_thong_tin_nhan_dang.address"},
                # "mobi_phone": {"$addToSet": {"$each":"$1_1_thong_tin_nhan_dang.phone.mobi_phone"}},
                # "fixed_phone": {"$addToSet":{"$each":"$1_1_thong_tin_nhan_dang.phone.fixed_phone"}},
                "mobi_phone": {"$addToSet": "$1_1_thong_tin_nhan_dang.phone.mobi_phone"},
                "fixed_phone": {"$addToSet":"$1_1_thong_tin_nhan_dang.phone.fixed_phone"},
                "header": {"$addToSet":"$1_1_thong_tin_nhan_dang.header"},
                "time_query": {"$addToSet":"$1_1_thong_tin_nhan_dang.time_query"},
                }},
            {"$out": 'customer1'}
        ]
